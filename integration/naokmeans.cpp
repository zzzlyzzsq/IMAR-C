...
/**
 * \fn void kmLloydAlgorithm(int iterations, int dim,  const KMdata& dataPts, int k, KMfilterCenters& ctrs)
 * \brief This is an a basic KMeans algorithm unoptimized.
 *
 * \param[in] iterationts The number of iterations coefficient which will determine the number of iterations in each phases.
 * \param[in] dim Points and centers's dimension.
 * \param[in] dataPts The data we want to compute the centers.
 * \param[in] k The number of centers.
 * \param[out] ctrs The centers.
