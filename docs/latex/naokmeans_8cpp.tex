...
void \hyperlink{naokmeans_8cpp_a78f6f33e72a52c581dfd286a3920f6bf}{exportSTIPs} (std::string stip, int dim, const KMdata \&dataPts)
\begin{DoxyCompactList}\small\item\em STIPs exportation function in the format 1 point = 1 line. Each dimension are separated from one space (\char`\"{} \char`\"{}). \item\end{DoxyCompactList}\item 
...
\index{naokmeans.cpp@{naokmeans.cpp}!exportSTIPs@{exportSTIPs}}
\index{exportSTIPs@{exportSTIPs}!naokmeans.cpp@{naokmeans.cpp}}
\subsubsection[{exportSTIPs}]{\setlength{\rightskip}{0pt plus 5cm}void exportSTIPs (std::string {\em stip}, \/  int {\em dim}, \/  const KMdata \& {\em dataPts})}}
\label{naokmeans_8cpp_a78f6f33e72a52c581dfd286a3920f6bf}


STIPs exportation function in the format 1 point = 1 line. Each dimension are separated from one space (\char`\"{} \char`\"{}). 


\begin{DoxyParams}{Parameters}
\item[\mbox{$\leftarrow$} {\em stip}]Name of the file containing the STIPs. \item[\mbox{$\leftarrow$} {\em dim}]The STIPs dimension. \item[\mbox{$\leftarrow$} {\em dataPts}]The KMlocal object which will be containing STIPs. \end{DoxyParams}
